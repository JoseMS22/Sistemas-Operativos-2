...
# Se define política restrictiva: todo DROP por defecto.
# - SSH abierto globalmente con rate limit
# - GlusterFS permitido solo dentro del VPC (172.31.16.0/20)
# - ICMP limitado
...
table inet filter {
  ...
  chain input {
    ...
    # GlusterFS solo entre nodos del VPC
    ip saddr @cluster_nodes tcp dport { 24007, 24008, 49152-49251 } accept
